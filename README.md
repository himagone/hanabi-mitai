...
| 大会 | 開花直径 | 最大号数 |
|------|----------|----------|
| 隅田川花火大会（第一会場） | 150m | 5号玉 |
| 隅田川花火大会（第二会場） | 150m | 5号玉 |
| 足立の花火 | 120m | 4号玉 |
| 江戸川区花火大会 | 240m | 8号玉 |
| 葛飾納涼花火大会 | 120m | 4号玉 |
| ふくろい遠州の花火 | 240m | 8号玉 |

花火の開花直径は大会ごとに設定され、スコアリング（見かけの大きさ・開花高度）に反映される。打上地点は公式情報・Nominatim 逆ジオコーディングで検証済み。隅田川は台船から打ち上げるため川中央の座標を使用。
